                      ...
                      <div className="space-y-3">
                        ...
                        <div className="px-4 pb-4 flex gap-2 flex-wrap">
                          <Button
                            size="sm"
                            variant="ghost"
                            onClick={() => handleDownload(message.imageUrl!, message.type as "image" | "video")}
                            className="text-xs"
                          >
                          ...
                          {message.jobId && (
                            <Button
                              size="sm"
                              variant="ghost"
                              onClick={() => handleShare(message.jobId!)}
                              className="text-xs"
                            >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex gap-3">
            <Textarea
              ...
              className="flex-1 min-h-[52px] max-h-32 resize-none bg-muted/50 border-border/40 rounded-xl"
