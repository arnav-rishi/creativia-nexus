...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <section className="relative z-10 flex flex-col items-center justify-center min-h-[70vh] px-6 pt-24 pb-16">
        <div className="flex flex-col items-center w-full max-w-4xl text-center">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-6 animate-fade-in" style={{ animationDelay: "100ms" }}>
          ...
          {/* Subheadline */}
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-10 animate-fade-in" style={{ animationDelay: "200ms" }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center animate-fade-in" style={{ animationDelay: "300ms" }}>
            <Button 
              ...
              size="lg"
              className="h-14 px-10 text-base font-medium rounded-full bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300"
            >
              Generate Now
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {capabilities.map((cap) => (
              <CapabilityCard
                ...
                icon={cap.icon}
                onClick={() => navigate(`/generate?mode=${cap.mode}`)}
              />
            ))}
          </div>
        </div>
      ...
      <section className="relative z-10 py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Button 
            onClick={handleGenerateClick}
            size="lg"
            className="h-14 px-10 text-base font-medium rounded-full bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg shadow-primary/25"
          >
            Get Started Free
            <ArrowRight size={18} className="ml-2" />
          </Button>
